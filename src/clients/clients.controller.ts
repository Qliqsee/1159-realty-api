...
export class ClientsController {
  ...
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 404, description: 'Client not found' })
  updateProfile(@Req() req: Request, @Body() updateData: UpdateClientDto) {
  ...
  @ApiResponse({ status: 200, description: 'Agent information retrieved successfully' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 404, description: 'Client not found' })
  getMyAgent(@Req() req: Request) {
  ...
  @ApiResponse({ status: 200, description: 'Partner information retrieved successfully' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 404, description: 'Client not found' })
  getMyPartner(@Req() req: Request) {
    const clientId = req.user['client']?.id;
